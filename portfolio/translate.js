const i18Obj = {
    'en': {
      ...
      'summer': 'Summer',
      'autumn': 'Autumn',
      'price-description-standard': 'Standard',
      'price-description-premium': 'Premium',
      'price-description-gold': 'Gold',
    ...
    'ru': {
      ...
      'hero-text-2': 'счастливые моменты жизни вместе с профессиональным фотографом Алексой Райс',
      'hero-text-3': '',
      'hire': 'Пригласить',
      ...
      'summer': 'Лето',
      'autumn': 'Осень',
      'price-description-standard': 'Стандартный',
      'price-description-premium': 'Премиальный',
      'price-description-gold': 'Золотой',
